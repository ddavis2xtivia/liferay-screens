...
public class OAuthCredentialsStoreKeyChain : BaseCredentialsStoreKeyChain {
	...
	override public func storeAuth(keychain keychain: Keychain, auth: LRAuthentication) throws {
	...
	override public func loadAuth(keychain keychain: Keychain) throws -> LRAuthentication? {
